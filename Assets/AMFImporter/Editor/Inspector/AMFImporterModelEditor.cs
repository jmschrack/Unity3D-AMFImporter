...
using UnityEditor;
    ...
    public class AMFImporterModelEditor : BaseAssetImporterTabUI
    {
        // Scene
        ...
        SerializedProperty m_UnwrapSettings;
        ...
        internal override void OnEnable()
        {
            ...
            m_SecondaryUVHardAngle = serializedObject.FindProperty("hardAngle");
            m_SecondaryUVPackMargin = serializedObject.FindProperty("packMargin");
        ...
        bool HelpBoxWithButton(GUIContent messageContent, GUIContent buttonContent, MessageType type)
        {
            ...
            GUI.Label(contentRect, messageContent.text,  EditorStyles.helpBox);//EditorGUIUtility.IconContent("_Help"),
