...
{
    public static class AvatarSetupTool
    {
        [System.Serializable]
        public class BoneWrapper
        {
            ...
            /* public void BoneDotGUI(Rect rect, Rect selectRect, int boneIndex, bool doClickSelect, bool doDragDrop, bool doDeleteKey, SerializedObject serializedObject, AvatarMappingEditor editor)
            {
                ...
                // Selection
                var AvatarMappingEditor=Type.GetType("UnityEditor.AvatarMappingEditor");
        ...
        public struct SkeletonBone
        {
            ...
            public static implicit operator UnityEngine.SkeletonBone(SkeletonBone x)
            {
                UnityEngine.SkeletonBone sb = new UnityEngine.SkeletonBone();
                sb.name=x.name;
                sb.position=x.position;
                sb.rotation=x.rotation;
                sb.scale=x.scale;
                return sb;
            }
        ...
        public static List<string> SetupHumanSkeleton(GameObject modelPrefab, ref HumanBone[] humanBoneMappingArray, out SkeletonBone[] skeletonBones, out bool hasTranslationDoF)
        {
            ...
            bool isBiped = AvatarBipedMapper.IsBiped(modelInstance.transform, reports);
            //SimpleProfiler.End();
            ...
            if (isBiped)
            {
                ...
                mapping = AdjutantSharp.AvatarBipedMapper.MapBones(modelInstance.transform);
                //SimpleProfiler.End();
            }
            else
            {
                //SimpleProfiler.Begin("MapBones");
                mapping = AdjutantSharp.AvatarAutoMapper.MapBones(modelInstance.transform, modelBones);
                //SimpleProfiler.End();
            }
            ...
            else
            {
                ...
                AdjutantSharp.AvatarBipedMapper.BipedPose(modelInstance, humanBones);
                //SimpleProfiler.End();
...
/* 
            ...
            // Check that mapping matches reference mapping
            {
                ...
                else
                {
                    ...
                    for (int i = 0; i < humanBones.Length; i++)
                    {
                        ...
                        if (!AdjutantSharp.AvatarMappingEditor.MatchName(actualBoneName, referenceBoneName))
                        {
                            mismatch = true;
        ...
        public static void TransferPoseToDescription(Transform transform, bool isRoot, List<SkeletonBone> skeletonBones)
        {
